    ...
    <div className="bg-white rounded-2xl shadow-xl p-8">
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-6 py-3 bg-coba-teal text-coba-cream rounded-lg hover:bg-coba-charcoal transition-colors"
              >
                Agregar
              </button>
            </div>
        ...
        <div className="text-center">
          <button
            type="submit"
            className="inline-flex items-center px-8 py-4 bg-coba-teal hover:bg-coba-charcoal text-coba-cream font-semibold rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
          >
