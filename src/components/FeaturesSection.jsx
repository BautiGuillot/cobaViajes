    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">¿Por Qué Elegir Coba Viajes?</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Somos tu mejor aliado para crear experiencias de viaje inolvidables con más de 15 años de experiencia</p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-gray-600 font-medium">Soporte al Cliente</div>
            </div>
          </div>
        </div>
      </div>
