        ...
        <aside className="lg:col-span-1">
          <div className="bg-white rounded-2xl shadow p-6 sticky top-4">
            ...
            <a
              ...
              className="w-full inline-flex items-center justify-center px-4 py-3 rounded-lg bg-green-600 hover:bg-green-700 text-white font-medium transition-colors"
            >
